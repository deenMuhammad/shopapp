      ...
      render() {
        return this.state.empty ? (
          ...
          <ScrollView
            ...
            />
            <BottomSpinner hasMore={this.state.hasMore} next={this.state.next}/>
          </ScrollView>
        );
      }
    },
...
//bottom spinner 
const BottomSpinner = (props) => {
  return (
    <View style={styles.bottomSpinner}>
      {props.hasMore&&props.next>1?<Spinner size={22} />:props.hasMore?null:<Text>finish :(</Text>}
    </View>
  );
};
