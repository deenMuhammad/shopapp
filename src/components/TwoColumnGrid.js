...
export default props => {
    ...
    const computedStyles = {
        sp: { width: props.bordered ? (w / 2 - 5) : (w / 2 - w * 0.02 - 5), height: w / 2 - w * 0.02 + 50, margin: w * 0.01, backgroundColor: '#fff', borderRadius: 5, overflow: 'hidden' },
        m: { width: props.bordered ? (w / 2 - 5) : (w / 2 - w * 0.02 - 5), height: w / 2 - w * 0.02 + 70, margin: w * 0.01, backgroundColor: '#fff', borderRadius: 5, overflow: 'hidden' },
        s: { width: props.bordered ? (w / 2 - 5) : (w / 2 - w * 0.02 - 5), height: w / 2 - w * 0.02 + 90, margin: w * 0.01, backgroundColor: '#fff', borderRadius: 5, overflow: 'hidden' },
        l: { width: props.bordered ? (w / 2 - 5) : (w / 2 - w * 0.02 - 5), height: w / 2 - w * 0.02 + 100, margin: w * 0.01, backgroundColor: '#fff', borderRadius: 5, overflow: 'hidden' },
    }
